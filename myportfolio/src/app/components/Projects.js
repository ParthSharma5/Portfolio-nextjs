        ...
        {filteredProjects.map((project, index) => (
          <motion.div
            ...
            className="group
              ...
              rounded-2xl shadow-xl hover:shadow-2xl hover:shadow-indigo-500/20
          ...
          >
            ...
            <div className="relative bg-gradient-to-r from-indigo-500/10 to-purple-500/10 p-6 border-b dark:border-gray-700 border-gray-200">
              ...
              {/* Project Meta Info */}
              {(project.date || project.featured) && (
                <div className="flex items-center gap-4 mt-3 text-sm dark:text-gray-400 text-gray-500">
                  {project.date && (
                    <div className="flex items-center gap-1">
                      <FiCalendar className="w-4 h-4" />
                      <span>{project.date}</span>
            ...
            <div className="p-6">
              {/* Description */}
              <p className="dark:text-gray-300 text-gray-600 leading-relaxed mb-6 line-clamp-3 group-hover:line-clamp-none transition-all duration-300">
                {project.description}
              </p>
                ...
                {project.github && (
                  <motion.a
                    ...
                    className="inline-flex items-center justify-center gap-2
                      ...
                      px-4 py-2 sm:px-5 sm:py-2.5 rounded-lg font-medium
                      transition-all duration-300 flex-1 sm:flex-none text-center min-w-[120px]"
                  >
                    <FiGithub className="w-4 h-4" />
                    Code
                  </motion.a>
              ...
              {project.languagesUsed && (
                <div className="mt-4 pt-4 border-t dark:border-gray-700 border-gray-200">
                  <h3 className="dark:text-white text-gray-800 font-semibold mb-3 flex items-center gap-2 text-sm uppercase tracking-wider dark:text-gray-400 text-gray-500">
                    <span className="w-2 h-2 bg-indigo-500 rounded-full"></span>
                    Technologies
                  </h3>
                  <div className="flex flex-wrap gap-2">
                    {project.languagesUsed.map((lang, i) => (
                      <motion.span
                        ...
                        className="px-3 py-1.5
                          ...
                          border dark:border-gray-600/50 border-gray-300
                          backdrop-blur-sm"
                      >
                        {lang}
                      </motion.span>
              ...
              {(project.duration || project.team) && (
                <div className="mt-4 pt-4 border-t dark:border-gray-700 border-gray-200">
                  <div className="grid grid-cols-2 gap-4 text-xs dark:text-gray-400 text-gray-500">
                    {project.duration && (
                      <div>
                        <div className="font-semibold dark:text-gray-500 text-gray-600">
                          Duration
                        </div>
                        <div>{project.duration}</div>
                      </div>
