...
export default function Footer() {
  ...
  return (
    ...
    ">
      {/* Main Footer Content */}
      {/* ... (if you had any main content, adapt similarly) */}
      ...
      <motion.div
        ...
        className="
          border-t dark:border-gray-700 border-gray-200
          dark:bg-gray-900/50 bg-white/70 backdrop-blur-sm
        "
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4 text-center sm:text-left">
            ...
            <motion.p
              ...
              transition={{ duration: 0.6, delay: 0.5 }}
              viewport={{ once: true }}
              className="dark:text-gray-400 text-gray-600 text-sm sm:text-base flex items-center justify-center gap-2 flex-wrap"
            >
              <span>© {currentYear} Parth Sharma. All rights reserved.</span>
            </motion.p>
            ...
            <motion.div
              ...
              transition={{ duration: 0.6, delay: 0.6 }}
              viewport={{ once: true }}
              className="flex items-center gap-4 text-sm sm:text-base dark:text-gray-400 text-gray-600"
            >
              <span className="flex items-center gap-2">
                Made with
                <motion.span
          ...
          <motion.div
            ...
            transition={{ duration: 0.6, delay: 0.7 }}
            viewport={{ once: true }}
            className="text-center sm:hidden mt-3 pt-3 border-t dark:border-gray-700 border-gray-200"
          >
            <p className="dark:text-gray-500 text-gray-500 text-xs flex items-center justify-center gap-2">
              <FaCode className="text-cyan-400" />
              Crafted by Parth Sharma
            </p>
          </motion.div>
